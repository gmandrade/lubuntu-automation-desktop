...
sudo apt-get install curl vim dnsutils xscreensaver net-tools sysstat ansible trash-cli shutter -y
echo "xscreensaver -nosplash" >> /home/$USER/.config/lxsession/Lubuntu/autostart
sudo curl -fsSL https://get.docker.com | sudo bash
sudo usermod -aG docker $USER
echo "setxkbmap -model abnt2 -layout br" >> /home/$USER/.bashrc
...
rm -f microsoft.gpg
sudo apt-get upgrade linux-generic linux-headers-generic linux-image-generic lubuntu-gtk-core
curl "https://bootstrap.pypa.io/get-pip.py" -o "get-pip.py"
sudo python3.6 get-pip.py
sudo python3 get-pip.py
sudo python get-pip.py
rm -f get-pip.py
mkdir /home/$USER/shellScripts/

cat <<EOF | tee /home/$USER/shellScripts/cleanFiles.sh
#!/usr/bin/env bash

# Paths to clean in fs
# This routine will executed in every reboot
rm -rf /tmp/*
rm -rf /home/$USER/Downloads/*
trash-empty
EOF

chmod +x /home/$USER/shellScripts/cleanFiles.sh

cat <<EOF | tee /etc/cron.d/clean-files
@reboot root /home/$USER/shellScripts/cleanFiles.sh &> /dev/null
EOF

cat <<EOF | tee /usr/share/applications/lubuntu-screenlock.desktop
[Desktop Entry]
Name=ScreenLock
...
cat <<EOF | tee /home/$USER/.config/openbox/lubuntu-rc.xml
